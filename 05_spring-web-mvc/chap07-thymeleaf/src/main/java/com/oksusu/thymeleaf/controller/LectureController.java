package com.oksusu.thymeleaf.controller;

import com.oksusu.thymeleaf.model.dto.MemberDTO;
import com.oksusu.thymeleaf.model.dto.SelectCriteria;
...
public class LectureController {
    ...
    public ModelAndView expression(ModelAndView mv) {
        mv.addObject("member", new MemberDTO("옥수수", 25, 'F', "서울시 강남구"));
    ...
    public ModelAndView etc(ModelAndView mv) {
        ...
        MemberDTO member = new MemberDTO("옥수수", 25, 'F', "서울시 강남구");
